...
namespace LMS.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        string CreateNewUser(string firstName, string lastName, DateTime DOB, string departmentAbbrev, string role)
        {
            ...
            string randomUID = generator.Next(0, 1000000).ToString("D7");
            var uID = "u" + randomUID;
            while (studentIDs.Contains(uID) || professorsIDs.Contains(uID) || adminIDs.Contains(uID))
            {
                generator = new Random();
                randomUID = generator.Next(0, 1000000).ToString("D7");
                uID = "u" + randomUID;
            }
